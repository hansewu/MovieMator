...
@synthesize firstUsed = _firstUsed;
@synthesize lastReminded = _lastReminded;
@synthesize usesCount = _usesCount;
@synthesize eventCount = _eventCount;
@synthesize usesPerWeek = _usesPerWeek;
@synthesize declinedThisVersion = _declinedThisVersion;
@synthesize declinedAnyVersion = _declinedAnyVersion;
@synthesize ratedThisVersion = _ratedThisVersion;
@synthesize ratedAnyVersion = _ratedAnyVersion;
...
- (void)dealloc
{
    if (_appStoreCountry != nil) {
        [_appStoreCountry release];
        _appStoreCountry = nil;
    }
    ...
    if (_applicationBundleID != nil) {
        [_applicationBundleID release];
        _applicationBundleID = nil;
    }
    ...
    if (_cancelButtonLabel != nil) {
        [_cancelButtonLabel release];
        _cancelButtonLabel = nil;
    }
    
    if (_remindButtonLabel != nil) {
        [_remindButtonLabel release];
        _remindButtonLabel = nil;
    }
    
    if (_rateButtonLabel != nil) {
        [_rateButtonLabel release];
        _rateButtonLabel = nil;
    }
    ...
    if (_lastReminded != nil) {
        [_lastReminded release];
        _lastReminded = nil;
    }
...
{
#if MOVIEMATOR_PRO
   [iRate sharedInstance].appStoreID = 1178887999;
#else
    [iRate sharedInstance].appStoreID = 1197748527;
#endif
}
