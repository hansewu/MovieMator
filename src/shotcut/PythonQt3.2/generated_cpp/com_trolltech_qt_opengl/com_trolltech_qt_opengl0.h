...
{ public:
inline bool  promoted_chooseContext(const QGLContext*  shareContext = 0) { return this->chooseContext(shareContext); }
...
inline bool  py_q_chooseContext(const QGLContext*  shareContext = 0) { return QGLContext::chooseContext(shareContext); }
inline bool  py_q_create(const QGLContext*  shareContext = 0) { return QGLContext::create(shareContext); }
...
void delete_QGLContext(QGLContext* obj) { delete obj; } 
   ...
   bool  py_q_chooseContext(QGLContext* theWrappedObject, const QGLContext*  shareContext = 0){  return (((PythonQtPublicPromoter_QGLContext*)theWrappedObject)->py_q_chooseContext(shareContext));}
   ...
   bool  py_q_create(QGLContext* theWrappedObject, const QGLContext*  shareContext = 0){  return (((PythonQtPublicPromoter_QGLContext*)theWrappedObject)->py_q_create(shareContext));}
