...
inline bool  py_q_feature(const QString&  name, bool*  ok = 0) const { return this->feature(name, ok); }
...
inline bool  py_q_parse(const QXmlInputSource*  input) { return this->parse(input); }
inline void*  py_q_property(const QString&  name, bool*  ok = 0) const { return this->property(name, ok); }
...
void delete_QXmlReader(QXmlReader* obj) { delete obj; } 
   ...
   bool  py_q_feature(QXmlReader* theWrappedObject, const QString&  name, bool*  ok = 0) const{  return (((PythonQtPublicPromoter_QXmlReader*)theWrappedObject)->py_q_feature(name, ok));}
   ...
   void*  py_q_property(QXmlReader* theWrappedObject, const QString&  name, bool*  ok = 0) const{  return (((PythonQtPublicPromoter_QXmlReader*)theWrappedObject)->py_q_property(name, ok));}
...
inline bool  py_q_feature(const QString&  name, bool*  ok = 0) const { return QXmlSimpleReader::feature(name, ok); }
...
inline void*  py_q_property(const QString&  name, bool*  ok = 0) const { return QXmlSimpleReader::property(name, ok); }
...
void delete_QXmlSimpleReader(QXmlSimpleReader* obj) { delete obj; } 
   ...
   bool  py_q_feature(QXmlSimpleReader* theWrappedObject, const QString&  name, bool*  ok = 0) const{  return (((PythonQtPublicPromoter_QXmlSimpleReader*)theWrappedObject)->py_q_feature(name, ok));}
   ...
   void*  py_q_property(QXmlSimpleReader* theWrappedObject, const QString&  name, bool*  ok = 0) const{  return (((PythonQtPublicPromoter_QXmlSimpleReader*)theWrappedObject)->py_q_property(name, ok));}
