...
Rectangle {
                        ...
                        Column {
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    height: Logic.trackHeight(multitrack.video)
                                }
                            }
                        }
                        Column {
    ...
    Menu {
        ...
        MenuItem {
            text:qsTr('Add Filter Track')
            onTriggered: timeline.addFilterTrack();
        }
        MenuItem {
    ...
    DelegateModel {
        ...
        Track {
            ...
            height: Logic.trackHeight(multitrack.video)
            isAudio: audio
            isVideo: multitrack.video
            isFilter: multitrack.filter
            trackType: multitrack.trackType
