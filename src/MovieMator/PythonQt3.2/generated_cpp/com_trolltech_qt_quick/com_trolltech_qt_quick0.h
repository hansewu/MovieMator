...
{ Q_OBJECT
public:
Q_ENUMS(Flag ItemChange TransformOrigin )
enum Flag{
...
enum TransformOrigin{
  TopLeft = QQuickItem::TopLeft,   Top = QQuickItem::Top,   TopRight = QQuickItem::TopRight,   Left = QQuickItem::Left,   Center = QQuickItem::Center,   Right = QQuickItem::Right,   BottomLeft = QQuickItem::BottomLeft,   Bottom = QQuickItem::Bottom,   BottomRight = QQuickItem::BottomRight};
public slots:
...
enum CreateTextureOption{
  TextureHasAlphaChannel = QQuickWindow::TextureHasAlphaChannel,   TextureHasMipmaps = QQuickWindow::TextureHasMipmaps,   TextureOwnsGLTexture = QQuickWindow::TextureOwnsGLTexture,   TextureCanUseAtlas = QQuickWindow::TextureCanUseAtlas};
enum RenderStage{
  BeforeSynchronizingStage = QQuickWindow::BeforeSynchronizingStage,   AfterSynchronizingStage = QQuickWindow::AfterSynchronizingStage,   BeforeRenderingStage = QQuickWindow::BeforeRenderingStage,   AfterRenderingStage = QQuickWindow::AfterRenderingStage,   AfterSwapStage = QQuickWindow::AfterSwapStage};
public slots:
...
enum CreateTextureOption{
  TextureHasAlphaChannel = QSGEngine::TextureHasAlphaChannel,   TextureOwnsGLTexture = QSGEngine::TextureOwnsGLTexture,   TextureCanUseAtlas = QSGEngine::TextureCanUseAtlas};
public slots:
