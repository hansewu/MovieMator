...
public:
    ...
    // New interface
    static bool compressFile(QuaZip* pZip, QString strFileName, QString strFileDest,
                             int (*pCallBack)(int, void*), void *pUserData);

    static bool compressDir(QuaZip* pZip, QString strDir, QString strOrigDir,
                               int (*pCallBack)(int, void*), void *pUserData);
