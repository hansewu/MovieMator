...
#define VER_LEGALCOPYRIGHT_STR      "Copyright © 2007-2015 Speedovation"
...
#define UPDATE_URL                  ""  // "http://kineticwing.com/tree.xml"

//IMP to crash reporter
#define CRASHREPORTER_SUBMIT_URL    ""  // "http://kineticwing.com/app-crash-upload"
